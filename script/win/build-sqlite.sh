...
node-gyp rebuild  --msvs_version=2015 --target=3.0.2 --arch=x64 --target_platform=win32 --dist-url=https://atom.io/download/electron --module_name=node_sqlite3 --module_path=../lib/binding/electron-v3.0-win32-x64
